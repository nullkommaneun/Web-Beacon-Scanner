// Stellt sicher, dass das Skript erst ausgeführt wird, wenn das DOM vollständig geladen ist.
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function startScan() {
        ...
        try {
            ...
            log("Filter: "ReadBeacon & Eddystone""); // Vereinfachte Log-Ausgabe
            ...
            scanStartBtn.disabled = false; // Button wieder freigeben
        }
    }
